...
export function AnimatedDashboardBackground({
  ...
  return (
    <div className="relative isolate">
      <div
        aria-hidden="true"
        className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(124,58,237,0.14)_0%,rgba(124,58,237,0)_28%),radial-gradient(circle_at_top_right,rgba(210,255,30,0.24)_0%,rgba(210,255,30,0)_24%),linear-gradient(180deg,#f8f6f3_0%,#f1efeb_58%,#f3f1ec_100%)] [clip-path:inset(0)]"
      >
