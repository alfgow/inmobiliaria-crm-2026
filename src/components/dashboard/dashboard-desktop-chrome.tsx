        ...
        <header className="rounded-[2rem] border border-border-soft bg-white/85 px-5 py-4 shadow-[0_16px_45px_rgba(44,44,44,0.06)] backdrop-blur-2xl">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden items-center gap-2 rounded-2xl border border-border-soft bg-surface-1 px-4 py-3 text-sm text-[#6b7280] shadow-sm xl:flex">
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-border-soft bg-surface-1 px-3 py-2 shadow-sm">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-secondary text-white">
                  <UserCircle2 className="h-5 w-5" />
                </div>
                <div>
                  <p className="text-sm font-medium text-[#2c2c2c]">Alfonso</p>
                  <p className="text-xs text-[#6b7280]">Operaciones y ventas</p>
                </div>
              </div>
            </div>
          </div>
